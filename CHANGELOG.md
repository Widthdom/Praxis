...
- The command/search fields now use a lighter glass fill while hiding the normal Mac entry border and preserving the focused underline; modal editor fields and modal action buttons now use matching pale glass controls, and modal/Quick Look popups use stronger native material blur for a clearer frosted-glass effect
