...
- Glassmorphism shell in both light and dark themes, with transparent app chrome/root/base surfaces plus separate semi-transparent blurred popup panels on Windows and macOS
...
- ライト / ダーク両テーマで glassmorphism を採用し、透明なアプリクローム/root/base 面と半透明・背面ぼかしの独立ポップアップパネルを Windows / macOS の両方で使う
