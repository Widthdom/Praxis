...
- On Windows, command input applies native `InputScopeNameValue.AlphanumericHalfWidth` to suppress IME conversion in the command box.
...
- Windows の Command 入力欄はネイティブ `InputScopeNameValue.AlphanumericHalfWidth` を設定し、IME 変換を抑止します。
