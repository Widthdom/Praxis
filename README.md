...
- Glassmorphism shell in both light and dark themes, with transparent app chrome/root surfaces plus a semi-transparent frosted dummy-root RoundRect and popup panels on Windows and macOS
...
- ライト / ダーク両テーマで glassmorphism を採用し、透明なアプリクローム/root 面と半透明・背面ぼかしの dummy-root RoundRect / ポップアップパネルを Windows / macOS の両方で使う
