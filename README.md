...
- Glassmorphism shell in both light and dark themes, with transparent app chrome plus semi-transparent blurred panels on Windows and macOS
...
- ライト / ダーク両テーマで glassmorphism を採用し、透明なアプリクロームと半透明・背面ぼかしのパネルを Windows / macOS の両方で使う
