...
- Glassmorphism shell in both light and dark themes, with transparent app chrome/root surface plus separate semi-transparent blurred panels on Windows and macOS
...
- ライト / ダーク両テーマで glassmorphism を採用し、透明なアプリクローム/root 面と半透明・背面ぼかしの独立パネルを Windows / macOS の両方で使う
