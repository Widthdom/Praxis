...
public partial class MainPage : ContentPage
{
    ...
    private async void CopyIconButton_Clicked(object? sender, EventArgs e)
    {
        ...
        {
            var safeMessage = CrashFileLogger.SafeExceptionMessage(ex);
            CrashFileLogger.WriteWarning("MainPage.CopyIconButton_Clicked", $"Copy notice animation failed while overlayVisible={CopyNoticeOverlay.IsVisible} tokenCanceled={token.IsCancellationRequested}: {safeMessage}");
        }
        finally
        {
