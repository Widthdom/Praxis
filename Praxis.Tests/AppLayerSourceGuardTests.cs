...
public class AppLayerSourceGuardTests
{
    ...
    public void MainPage_MacPlacementScroll_UsesNativeRecognizersForEmptySpaceActions()
    {
        ...
        Assert.Contains("private static readonly Point MacPlacementSelectionPointerOffset = new(-4, -14);", macSource);
        Assert.Contains("private static Point ApplyMacPlacementSelectionPointerOffset(Point rootPoint)", macSource);
        ...
        Assert.Contains("var selectionRootPoint = ApplyMacPlacementSelectionPointerOffset(lockedRootPoint);", macSource);
        ...
        Assert.Contains("macPlacementNativeSelectionStartRootPoint = selectionRootPoint;", macSource);
        Assert.Contains("UpdateMacPlacementNativeSelectionOverlay(macPlacementNativeSelectionStartRootPoint ?? selectionRootPoint, selectionRootPoint);", macSource);
