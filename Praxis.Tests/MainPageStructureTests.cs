...
public class MainPageStructureTests
{
    ...
    public void MainPage_GlassmorphismSurface_IsTransparentAndUsesMaterialFrames()
    {
        ...
        Assert.Contains("MacOSBackdropOpacity=\"0\"", xaml);
        ...
        Assert.Contains("Stroke=\"Transparent\"\n                                StrokeThickness=\"0\"\n                                BackgroundColor=\"{AppThemeBinding Light={StaticResource DummyRootGlassLight}, Dark={StaticResource DummyRootGlassDark}}\"", xaml);
        ...
        Assert.Contains("<Color x:Key=\"GlassInputLight\">#2AFFFFFF</Color>", xaml);
        Assert.Contains("<Color x:Key=\"GlassInputDark\">#38363B43</Color>", xaml);
        Assert.Contains("<Color x:Key=\"GlassModalInputLight\">#40FFFFFF</Color>", xaml);
        Assert.Contains("<Color x:Key=\"GlassModalInputDark\">#46363B43</Color>", xaml);
        Assert.Contains("<Color x:Key=\"GlassButtonLight\">#42FFFFFF</Color>", xaml);
        Assert.Contains("<Color x:Key=\"GlassButtonDark\">#44363B43</Color>", xaml);
        ...
        Assert.True(CountOccurrences(xaml, "MacOSBackdropOpacity=\"0.82\"") >= 3);
