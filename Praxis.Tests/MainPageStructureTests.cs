...
public class MainPageStructureTests
{
    ...
    public void MainPage_GlassmorphismSurface_IsTransparentAndUsesMaterialFrames()
    {
        ...
        Assert.Contains("<Color x:Key=\"DummyRootGlassLight\">#14FFFFFF</Color>", xaml);
        Assert.Contains("<Color x:Key=\"DummyRootGlassDark\">#2421262D</Color>", xaml);
