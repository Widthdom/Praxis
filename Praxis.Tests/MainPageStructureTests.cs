...
public class MainPageStructureTests
{
    ...
    public void MainPage_GlassmorphismSurface_IsTransparentAndUsesMaterialFrames()
    {
        ...
        Assert.Contains("<Color x:Key=\"GlassModalInputDark\">#96434A54</Color>", xaml);
        ...
        Assert.Contains("<Color x:Key=\"GlassModalButtonLight\">#8AFFFFFF</Color>", xaml);
        Assert.Contains("<Color x:Key=\"GlassModalButtonDark\">#9A53606B</Color>", xaml);
